...
var HTMLskillsStart = '<span><h3 id="skills-h3">Skills at a Glance:</h3><ul id="skills" class="flex-column"></ul></span>';
...
var HTMLprojectImage = '<img class="boxShadow" src="%data%"><hr>';
